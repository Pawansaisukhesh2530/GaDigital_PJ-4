<?php
/**
 * Shared renderer for the 9 Oil Filled product pages.
 * Each page sets $slug then includes this file.
 */
require_once __DIR__ . '/config.php';
require_once __DIR__ . '/oil-filled-data.php';

$all = getOilFilledProducts();
if (!isset($all[$slug])) {
        ...
        <div class="product-detail-grid">
            ...
            <div class="product-detail-main" data-animation="fadeInUp">
                ...
                <div class="product-detail-gallery">
                    <?php foreach ($p['gallery'] as $img): ?>
                        <figure>
                            <img src="<?php echo ASSETS_PATH; ?>/images/products/<?php echo $img; ?>"
                ...
                <div class="product-faq">
                    ...
                    <div class="faq-item">
                        <button class="faq-question" type="button" aria-expanded="false" aria-controls="faq-oil-<?php echo $i; ?>">
                            <span><?php echo $faq['q']; ?></span>
                            <span class="faq-icon" aria-hidden="true"></span>
                        </button>
                        <div class="faq-answer" id="faq-oil-<?php echo $i; ?>" role="region">
                            <p><?php echo $faq['a']; ?></p>
                        </div>
                    </div>
                    <?php endforeach; ?>
